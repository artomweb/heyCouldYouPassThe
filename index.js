...
function areaClicked(areaName) {
  ...
  if (areaName === currentUtensilName) {
    console.log("Correct!");
    nextUtensil(); // This would load the next utensil, you would have to define this function
    response.innerHTML = ""; // Clear the response if the answer is correct
  } else {
    console.log(responseText);
    response.innerHTML = responseText;
    lastResponse = responseText; // Store the current response as the last response
  }
}
...
// Initialize the queue and shuffle
...
>>>>>>> 00361155ca6b5576d805350bb9354bfa25ca0588
}
